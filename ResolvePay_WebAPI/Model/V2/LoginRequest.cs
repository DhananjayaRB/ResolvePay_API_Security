...
namespace ResolvePay_WebAPI.Model.V2
{
    ...
    public class Details_PGSQL
    {
        ...
        public List<GetEmpPersonalDetails> personaldetails { get; set; }
        public Details_PGSQL()
        {
            personaldetails = new List<GetEmpPersonalDetails>();
        }
    ...
    {
        [Key]
        [JsonPropertyName("emppersonalid")]
        public int emppersonalid { get; set; }
    ...
    public class GetEmpPersonalDetails
    {
        [JsonPropertyName("emppersonalid")]
        public int emppersonalid { get; set; }
